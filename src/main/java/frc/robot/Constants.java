...
public final class Constants {
  ...
  // public static final double ROBOT_MASS = (100) * 0.453592; // 32lbs * kg per
  // pound***Need to change
  // // public static final Matter CHASSIS = new Matter(new Translation3d(0, 0,
  // Units.inchesToMeters(8)), ROBOT_MASS);
  // public static final double LOOP_TIME = 0.13; //s, 20ms + 110ms sprk max
  // velocity lag
  ...
  // }
  public static final double ROBOT_MASS = (140) * 0.45359237; // 32lbs * kg per pound
  public static final Matter CHASSIS = new Matter(new Translation3d(0, 9, Units.inchesToMeters(12)), ROBOT_MASS);
  public static final double LOOP_TIME = 0.40; // s, 20ms + 110ms sprk max velocity lag
